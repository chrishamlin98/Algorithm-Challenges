...
class Solution:
    # ---> "X" is 10 and "IX" is 9......while iterating IX: for i =0 we add the value of I to ans that is 1, , ,
    # ans becomes 1 for i=1 we see X value is 10 which is greater then prev so..we add 10 to ans and then substract prev
    # value.twice because we have; already; added; the; value; of; I and we; realised; that  #  IX is single term not
    # two; ans = ans + X(10) - 2 * I(1)
